        ...
        <div class="row">
            <div class="col-lg-4 col-md-6">
                <div class="fs-logo">
                    ...
                    <p class="text-white">
                        The City of Payris won the bid to host FunOlympic Games 2024. This platform for broadcasting olympic games and reach all its audience all over the world.
                    </p>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 ">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="fs-widget">
                    <div class="fs-logo">
                        <h4>Contact</h4>
                        <ul>
                            <li><i class="fa fa-envelope" style="color: white;"></i> info@funolympics.com</li>
                            <li><i class="fa fa-phone" style="color: white;"></i> +(12) 345 6789</li>
                            <li><i class="fa fa-map-marker" style="color: white;"></i> 01 Tinkune Kathmandu City, Nepal</li>
                        </ul>
        ...
        <div class="copyright-option">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <div class="co-text">
                        <p class="text-center">Copyright &copy;2024</script> All rights reserved</p>
                    </div>
                </div>
            </div>
        </div>
